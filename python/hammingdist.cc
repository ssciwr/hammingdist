...
PYBIND11_MODULE(hammingdist,m)
{
  ...
  m.def("from_fasta", &from_fasta, py::arg("filename"), py::arg("include_x") = false, py::arg("remove_duplicates") = false, py::arg("n") = 0, "Creates a dataset by reading from a fasta file (assuming all sequences have equal length)");
